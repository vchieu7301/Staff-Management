...
<html>
    ...
    <?php
        ...
        <tr>
            ...
            <tr>          
                <td>Department:</td>
                    <td> <select name="select_department" readonly="readonly">
            ...
            <tr>
                <td>Birthday:</td>
                    <td><input type="text" readonly="readonly" value="<?php echo $birthday ?>" name="birthday" size="30"></td>
            </tr>
            ...
            <tr>
                <td>Tel2:</td> 
                    <td><input type="number" readonly="readonly" readonly="readonly" value="<?php echo $tel2 ?>" name="tel2" size="30"></td>
            </tr>

            <tr>
                <td>Zip:</td>
                    <td><input type="number" readonly="readonly" value="<?php echo $zip ?>" name="zip" size="30"></td>
            </tr>
